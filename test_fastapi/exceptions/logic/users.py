...
from test_fastapi.exceptions import NotesApiError


class UserExistsError(NotesApiError):
    """
...
class UserNotFoundError(NotesApiError):
    """
...
class UserNotApprovedError(NotesApiError):
    """
...
class UserCredentialsInvalidError(NotesApiError):
    """
...
class AccessTokenExpiredError(NotesApiError):
    """
...
class AccessWithdrawnError(NotesApiError):
    """
...
class RefreshTokenNotFoundError(NotesApiError):
    """
...
class RefreshTokenExpiredError(NotesApiError):
    """
...
class AccessTokenUsedToRefreshError(NotesApiError):
    """
